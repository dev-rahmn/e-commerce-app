...
const addressSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder
      .addCase(getAllAddresses.pending, (state: AddressState) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(getAllAddresses.fulfilled, (state: AddressState, action) => {
        state.loading = false;
      ...
      .addCase(getAllAddresses.rejected, (state: AddressState, action) => {
        state.loading = false;
    ...
    builder
      .addCase(updateSelectedDeliveryAddressAsync.pending, (state: AddressState) => {
        state.selectedDeliveryAddress.loading = true;
        state.selectedDeliveryAddress.error = null;
      })
      .addCase(updateSelectedDeliveryAddressAsync.fulfilled, (state: AddressState, action) => {
      ...
      .addCase(updateSelectedDeliveryAddressAsync.rejected, (state: AddressState    , action) => {
        state.selectedDeliveryAddress.loading = false;
